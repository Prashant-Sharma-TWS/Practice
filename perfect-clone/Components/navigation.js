let setNavigation = (container, navBg) => {
  ...
  document
    .getElementById("searchInputBox2")
    .addEventListener("keypress", (e) => handleSearchKey(e));
  document
    .getElementById("searchInputBox1")
    .addEventListener("keypress", (e) => handleSearchKey(e));
  ...
  entries.forEach((entry) => {
    ...
    if (entry.target.id == "topSection") {
      if (!entry.isIntersecting) {
        ...
        document.getElementById("navigationContainerOne").style.transform =
          "translateY(-120px)";
        // document.getElementById('navigationContainerTwo').style.display = 'flex';
        document.getElementById("navigationContainerTwo").style.transform =
          "translateY(120px)";
        document.getElementById("footerBar").style.transform =
          "translateY(60px)";
      } else {
